...
def drawCircleOnSquare(area = 3601, specs = [60], stop = 0): # functia asta verifica toate cercurile desenate in patrat pana acum, ca sa determine
    ...
    center = [0, 0]
    whichLatura = 0
    # aici ma asigur ca se poate desena ceva pe latura actuala
    checkIt = [] # aici tin minte laturile care au fost deja incercate, ca sa nu le incerce de 2 ori in bucla
